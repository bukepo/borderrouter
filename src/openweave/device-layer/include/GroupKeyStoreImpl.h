...
#ifndef GROUP_KEY_STORE_IMPL_H
#define GROUP_KEY_STORE_IMPL_H
 ...
 */
class GroupKeyStoreImpl : public ::nl::Weave::Profiles::Security::AppKeys::GroupKeyStoreBase, private ESP32Config
{
...
public:
    ...
    virtual WEAVE_ERROR EnumerateGroupKeys(uint32_t  keyType,
                                           uint32_t *keyIds,
