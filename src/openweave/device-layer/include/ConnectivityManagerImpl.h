...
private:
    ...
    WEAVE_ERROR        _SetThreadMode(ThreadMode val);
    ...
    static void DriveStationState(::nl::Weave::System::Layer *aLayer,
                                  void *                      aAppState,
    ...
    static void DriveServiceTunnelState(::nl::Weave::System::Layer *aLayer,
                                        void *                      aAppState,
                                        ::nl::Weave::System::Error  aError);
